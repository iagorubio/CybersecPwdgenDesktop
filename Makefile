...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CybersecPwdgenDesktop1.0.0
DISTDIR = /home/iago/files/projects/cybersec_pwdgen_desktop/CybersecPwdgenDesktop/.tmp/CybersecPwdgenDesktop1.0.0
LINK          = g++
...
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		CybersecPwdgenDesktop.pro dialog.h main.cpp \
		dialog.cpp
QMAKE_TARGET  = CybersecPwdgenDesktop
DESTDIR       = 
TARGET        = CybersecPwdgenDesktop


first: all
####### Build rules

CybersecPwdgenDesktop: ui_dialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: CybersecPwdgenDesktop.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt5/mkspecs/features/yacc.prf \
		/usr/lib64/qt5/mkspecs/features/lex.prf \
		CybersecPwdgenDesktop.pro
	$(QMAKE) -o Makefile CybersecPwdgenDesktop.pro ' QMAKE_CFLAGS_DEBUG=-O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -m64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection ' ' QMAKE_CFLAGS_RELEASE=-O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -m64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection ' ' QMAKE_CXXFLAGS_DEBUG=-O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -m64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection ' ' QMAKE_CXXFLAGS_RELEASE=-O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -m64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection ' ' QMAKE_LFLAGS_DEBUG=-Wl,-z,relro -Wl,-z,now -specs=/usr/lib/rpm/redhat/redhat-hardened-ld' ' QMAKE_LFLAGS_RELEASE=-Wl,-z,relro -Wl,-z,now -specs=/usr/lib/rpm/redhat/redhat-hardened-ld' ' QMAKE_STRIP='
...
all: Makefile CybersecPwdgenDesktop
...
moc_dialog.cpp: dialog.h \
	...
	/usr/lib64/qt5/bin/moc $(DEFINES) --include /home/iago/files/projects/cybersec_pwdgen_desktop/CybersecPwdgenDesktop/moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/iago/files/projects/cybersec_pwdgen_desktop/CybersecPwdgenDesktop -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/8 -I/usr/include/c++/8/x86_64-redhat-linux -I/usr/include/c++/8/backward -I/usr/lib/gcc/x86_64-redhat-linux/8/include -I/usr/local/include -I/usr/include dialog.h -o moc_dialog.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/CybersecPwdgenDesktop/bin || mkdir -p $(INSTALL_ROOT)/opt/CybersecPwdgenDesktop/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/CybersecPwdgenDesktop/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/CybersecPwdgenDesktop/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/CybersecPwdgenDesktop/bin/ 
